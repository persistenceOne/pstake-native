...
pstaked tx cosmos set-orchestrator-address cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt cosmos1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jv6txhe --chain-id test --from test --keyring-backend=test -y -b block

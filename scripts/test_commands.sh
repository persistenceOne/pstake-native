...
pstaked tx bank send persistence183g695ap32wnds5k9xwd3yq997dqxudfts2gqg persistence12v9prjx8m5fdalryqd0t4mgwe20637ltek5m0h 10000000stake --chain-id test --from test --keyring-backend=test -y -b block
pstaked tx bank send persistence12v9prjx8m5fdalryqd0t4mgwe20637ltek5m0h persistence183g695ap32wnds5k9xwd3yq997dqxudfts2gqg 10stake --chain-id test --from test1 --keyring-backend=test -y -b block
...
pstaked tx cosmos incoming persistence1g5lz0gq98y8tav477dltxgpdft0wr9rmqt7mvu persistence12v9prjx8m5fdalryqd0t4mgwe20637ltek5m0h 10000000uatom cosmoshub-4 AE9ADDF593D45DDB09C8371F534AA773EB8CF288F63B09C160110338D362177B 100000 --chain-id test --from test1 --keyring-backend=test -y -b block

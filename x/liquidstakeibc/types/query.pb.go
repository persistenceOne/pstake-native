...
type QueryUserUnbondingsResponse struct {
	UserUnbonding []UserUnbonding `protobuf:"bytes,1,rep,name=user_unbonding,json=userUnbonding,proto3" json:"user_unbonding"`
}
...
var fileDescriptor_b143d1c5e28840b2 = []byte{
	...
	,
}
...
func (m *QueryUserUnbondingsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UserUnbonding) > 0 {
		for iNdEx := len(m.UserUnbonding) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UserUnbonding[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryUserUnbondingsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.UserUnbonding = append(m.UserUnbonding, UserUnbonding{})
			if err := m.UserUnbonding[len(m.UserUnbonding)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

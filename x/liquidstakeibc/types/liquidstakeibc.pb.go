...
type LSMDeposit struct {
	...
	// epoch when the deposit is created
	Epoch int64 `protobuf:"varint,7,opt,name=epoch,proto3" json:"epoch,omitempty"`
	// state o the deposit
	State LSMDeposit_LSMDepositState `protobuf:"varint,8,opt,name=state,proto3,enum=pstake.liquidstakeibc.v1beta1.LSMDeposit_LSMDepositState" json:"state,omitempty"`
	// sequence id of the ibc transaction
	IbcSequenceId string `protobuf:"bytes,9,opt,name=ibc_sequence_id,json=ibcSequenceId,proto3" json:"ibc_sequence_id,omitempty"`
}
...
func (m *LSMDeposit) GetEpoch() int64 {
	if m != nil {
		return m.Epoch
	}
	return 0
...
var fileDescriptor_71a9a61e676043b6 = []byte{
	...
	,
}

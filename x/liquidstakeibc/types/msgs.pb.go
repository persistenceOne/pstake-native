...
type MsgRegisterHostChain struct {
	...
	LocalDenom     string                                 `protobuf:"bytes,7,opt,name=local_denom,json=localDenom,proto3" json:"local_denom,omitempty"`
...
var fileDescriptor_dce3cdc829e5c7d3 = []byte{
	...
	,
}

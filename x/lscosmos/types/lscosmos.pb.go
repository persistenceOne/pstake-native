...
func (m *IbcAmountTransitionStore) String() string { return proto.CompactTextString(m) }
func (*IbcAmountTransitionStore) ProtoMessage()    {}
func (*IbcAmountTransitionStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dec47e30da12f63, []int{6}
}
func (m *IbcAmountTransitionStore) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IbcAmountTransitionStore) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IbcAmountTransitionStore.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IbcAmountTransitionStore) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IbcAmountTransitionStore.Merge(m, src)
}
func (m *IbcAmountTransitionStore) XXX_Size() int {
	return m.Size()
}
func (m *IbcAmountTransitionStore) XXX_DiscardUnknown() {
	xxx_messageInfo_IbcAmountTransitionStore.DiscardUnknown(m)
}

var xxx_messageInfo_IbcAmountTransitionStore proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*IbcAmountTransitionStore)(nil), "pstake.lscosmos.v1beta1.ibcAmountTransitionStore")
}
...
var fileDescriptor_4dec47e30da12f63 = []byte{
	...
	,
}
...
func (this *IbcAmountTransitionStore) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IbcAmountTransitionStore)
	if !ok {
		that2, ok := that.(IbcAmountTransitionStore)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *IbcAmountTransitionStore) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IbcAmountTransitionStore) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IbcAmountTransitionStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IbcAmountTransitionStore) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IbcAmountTransitionStore) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ibcAmountTransitionStore: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ibcAmountTransitionStore: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

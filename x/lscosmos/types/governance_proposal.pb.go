...
type RegisterHostChainProposal struct {
	...
	PstakeWithdrawalFee   github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,15,opt,name=pstake_withdrawal_fee,json=pstakeWithdrawalFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"pstake_withdrawal_fee"`
	PstakeFeeAddress      string                                 `protobuf:"bytes,16,opt,name=pstake_fee_address,json=pstakeFeeAddress,proto3" json:"pstake_fee_address,omitempty"`
}
...
type MinDepositAndFeeChangeProposal struct {
	...
	PstakeWithdrawalFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,7,opt,name=pstake_withdrawal_fee,json=pstakeWithdrawalFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"pstake_withdrawal_fee"`
}
...
var fileDescriptor_47404a6acaa6ce8f = []byte{
	...
	,
}
...
func (m *RegisterHostChainProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.PstakeWithdrawalFee.Size()
		i -= size
		if _, err := m.PstakeWithdrawalFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *RegisterHostChainProposal) Size() (n int) {
	...
	n += 1 + l + sovGovernanceProposal(uint64(l))
	l = m.PstakeWithdrawalFee.Size()
	n += 1 + l + sovGovernanceProposal(uint64(l))
	l = len(m.PstakeFeeAddress)
	if l > 0 {
		n += 2 + l + sovGovernanceProposal(uint64(l))
	}
	return n
}
...
func (m *RegisterHostChainProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PstakeWithdrawalFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PstakeWithdrawalFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:

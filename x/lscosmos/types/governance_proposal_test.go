	...
	testCases := []struct {
	...
	}{
		{
			...
			proposal: *types.NewRegisterHostChainProposal("title", "description", true,
				...
				sdk.OneInt().MulRaw(5),
				types.AllowListedValidators{AllowListedValidators: types.AllowListedVals{{ValidatorAddress: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", TargetWeight: sdk.OneDec()}}},
		...
		},
		{
			...
			proposal: *types.NewRegisterHostChainProposal("title", "description", true,
				...
				"uatom", "stk/uatom", "persistence1pss7nxeh3f9md2vuxku8q99femnwdjtcpe9ky9",
				sdk.OneInt().MulRaw(5),
				types.AllowListedValidators{AllowListedValidators: types.AllowListedVals{{ValidatorAddress: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", TargetWeight: sdk.ZeroDec()}}},
				sdk.ZeroDec(), sdk.ZeroDec(), sdk.ZeroDec(), sdk.ZeroDec(),
			),

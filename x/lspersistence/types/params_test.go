...
func TestValidateWhitelistedValidators(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			"lspersistence validator cannot be duplicated: cosmosvaloper10e4vsut6suau8tk9m6dnrm0slgd6npe3jx5xpv",
		},
		{
		...
		},
		{
			...
			"lspersistence validator target weight must not be nil",
		},
		{
			...
			"lspersistence validator target weight must be positive: -1",
		},
		{
			...
			"lspersistence validator target weight must be positive: 0",
		},
		{

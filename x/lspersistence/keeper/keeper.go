...
// Keeper of the lspersistence store
type Keeper struct {
...
// NewKeeper returns a lspersistence keeper. It handles:
...
func NewKeeper(cdc codec.BinaryCodec, key sdk.StoreKey, paramSpace paramtypes.Subspace,
	...
	// ensure lspersistence module account is set
...
// GetParams gets the parameters for the lspersistence module.
func (k Keeper) GetParams(ctx sdk.Context) (params types.Params) {
	k.paramSpace.GetParamSet(ctx, &params)
	return params
}

// SetParams sets the parameters for the lspersistence module.

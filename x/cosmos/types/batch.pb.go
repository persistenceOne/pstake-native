...
type CosmosTx struct {
	Tx                github_com_cosmos_cosmos_sdk_types_tx.Tx `protobuf:"bytes,1,opt,name=tx,proto3,customtype=github.com/cosmos/cosmos-sdk/types/tx.Tx" json:"tx"`
...
type ValuOutgoingUnbondStore struct {
	...
	UndelegateMessages []github_com_cosmos_cosmos_sdk_x_staking_types.MsgUndelegate `protobuf:"bytes,2,rep,name=undelegate_messages,json=undelegateMessages,proto3,customtype=github.com/cosmos/cosmos-sdk/x/staking/types.MsgUndelegate" json:"undelegate_messages"`
}
...
var fileDescriptor_cbd4e547303b7d7c = []byte{
	...
	,
}
...
func (m *ValuOutgoingUnbondStore) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UndelegateMessages) > 0 {
		for iNdEx := len(m.UndelegateMessages) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.UndelegateMessages[iNdEx].Size()
				i -= size
				if _, err := m.UndelegateMessages[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintBatch(dAtA, i, uint64(size))
			}
...
func (m *ValuOutgoingUnbondStore) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_cosmos_cosmos_sdk_x_staking_types.MsgUndelegate
			m.UndelegateMessages = append(m.UndelegateMessages, v)

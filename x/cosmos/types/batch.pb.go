...
type ProposalKey struct {
	ChainID     string `protobuf:"bytes,1,opt,name=chain_i_d,json=chainID,proto3" json:"chain_i_d,omitempty"`
	BlockHeight int64  `protobuf:"varint,2,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
	ProposalID  int64  `protobuf:"varint,3,opt,name=proposal_i_d,json=proposalID,proto3" json:"proposal_i_d,omitempty"`
}
...
func (m *ProposalKey) GetProposalID() int64 {
	if m != nil {
		return m.ProposalID
	}
	return 0
...
type ProposalValue struct {
	...
	VotingStartTime       time.Time `protobuf:"bytes,8,opt,name=voting_start_time,json=votingStartTime,proto3,stdtime" json:"voting_start_time,omitempty" yaml:"voting_start_time"`
	VotingEndTime         time.Time `protobuf:"bytes,9,opt,name=voting_end_time,json=votingEndTime,proto3,stdtime" json:"voting_end_time,omitempty" yaml:"voting_end_time"`
}
...
var fileDescriptor_cbd4e547303b7d7c = []byte{
	...
	,
}
